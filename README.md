...
php-account is a Laravel library for dealing with account management.

## Installation

Use the package manager [composer](https://getcomposer.org/download/) to install php-account.

``` bash
composer require walkerchiu/php-account
```
